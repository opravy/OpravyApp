...
var DataService = /** @class */ (function () {
    function DataService(db, afStorage) {
        this.db = db;
        this.afStorage = afStorage;
        this.reportsCollection = db.collection('Reports');
        this.reports = this.reportsCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (actions) {
    ...
    DataService.prototype.addReport = function (report) {
        return this.reportsCollection.add(report);
    };
    DataService.prototype.uploadImage = function (image) {
        var filePath = "report_image_" + new Date().getTime() + ".jpg";
