...
var map = {
	...
	"./pages/agregar-reporte/agregar-reporte.module": [
...
var routes = [
    { path: '', loadChildren: './pages/tabs/tabs.module#TabsPageModule', canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]] },
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            imports: [
                ...
                _angular_fire__WEBPACK_IMPORTED_MODULE_11__["AngularFireModule"].initializeApp(src_environments_environment__WEBPACK_IMPORTED_MODULE_15__["environment"].firebase),
...
var AuthGuard = /** @class */ (function () {
    ...
    AuthGuard = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _services_authentification_service__WEBPACK_IMPORTED_MODULE_3__["AuthentificationService"]])
    ], AuthGuard);
    return AuthGuard;
}());
...
var AuthentificationService = /** @class */ (function () {
    function AuthentificationService(firebaseAuth) {
    ...
    AuthentificationService.prototype.signUp = function (email, password) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.firebaseAuth
                .auth
...
var environment = {
    production: false,
    firebase: {
        apiKey: "AIzaSyAEAfxxoI7yAlL1QSFnELagz8MNzeng7TM",
        authDomain: "opravy-420df.firebaseapp.com",
        databaseURL: "https://opravy-420df.firebaseio.com",
        projectId: "opravy-420df",
        storageBucket: "opravy-420df.appspot.com",
        messagingSenderId: "898553215257",
        appId: "1:898553215257:web:47a196a05e0efdf6"
    }
};
/*
...
module.exports = __webpack_require__(/*! C:\Users\josh_\Desktop\OpravyApp\src\main.ts */"./src/main.ts");
